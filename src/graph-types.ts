...
export enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___cover___sourceInstanceName = 'childMarkdownRemark___frontmatter___cover___sourceInstanceName',
  childMarkdownRemark___frontmatter___cover___absolutePath = 'childMarkdownRemark___frontmatter___cover___absolutePath',
  childMarkdownRemark___frontmatter___cover___relativePath = 'childMarkdownRemark___frontmatter___cover___relativePath',
  childMarkdownRemark___frontmatter___cover___extension = 'childMarkdownRemark___frontmatter___cover___extension',
  childMarkdownRemark___frontmatter___cover___size = 'childMarkdownRemark___frontmatter___cover___size',
  childMarkdownRemark___frontmatter___cover___prettySize = 'childMarkdownRemark___frontmatter___cover___prettySize',
  childMarkdownRemark___frontmatter___cover___modifiedTime = 'childMarkdownRemark___frontmatter___cover___modifiedTime',
  childMarkdownRemark___frontmatter___cover___accessTime = 'childMarkdownRemark___frontmatter___cover___accessTime',
  childMarkdownRemark___frontmatter___cover___changeTime = 'childMarkdownRemark___frontmatter___cover___changeTime',
  childMarkdownRemark___frontmatter___cover___birthTime = 'childMarkdownRemark___frontmatter___cover___birthTime',
  childMarkdownRemark___frontmatter___cover___root = 'childMarkdownRemark___frontmatter___cover___root',
  childMarkdownRemark___frontmatter___cover___dir = 'childMarkdownRemark___frontmatter___cover___dir',
  childMarkdownRemark___frontmatter___cover___base = 'childMarkdownRemark___frontmatter___cover___base',
  childMarkdownRemark___frontmatter___cover___ext = 'childMarkdownRemark___frontmatter___cover___ext',
  childMarkdownRemark___frontmatter___cover___name = 'childMarkdownRemark___frontmatter___cover___name',
  childMarkdownRemark___frontmatter___cover___relativeDirectory = 'childMarkdownRemark___frontmatter___cover___relativeDirectory',
  childMarkdownRemark___frontmatter___cover___dev = 'childMarkdownRemark___frontmatter___cover___dev',
  childMarkdownRemark___frontmatter___cover___mode = 'childMarkdownRemark___frontmatter___cover___mode',
  childMarkdownRemark___frontmatter___cover___nlink = 'childMarkdownRemark___frontmatter___cover___nlink',
  childMarkdownRemark___frontmatter___cover___uid = 'childMarkdownRemark___frontmatter___cover___uid',
  childMarkdownRemark___frontmatter___cover___gid = 'childMarkdownRemark___frontmatter___cover___gid',
  childMarkdownRemark___frontmatter___cover___rdev = 'childMarkdownRemark___frontmatter___cover___rdev',
  childMarkdownRemark___frontmatter___cover___ino = 'childMarkdownRemark___frontmatter___cover___ino',
  childMarkdownRemark___frontmatter___cover___atimeMs = 'childMarkdownRemark___frontmatter___cover___atimeMs',
  childMarkdownRemark___frontmatter___cover___mtimeMs = 'childMarkdownRemark___frontmatter___cover___mtimeMs',
  childMarkdownRemark___frontmatter___cover___ctimeMs = 'childMarkdownRemark___frontmatter___cover___ctimeMs',
  childMarkdownRemark___frontmatter___cover___atime = 'childMarkdownRemark___frontmatter___cover___atime',
  childMarkdownRemark___frontmatter___cover___mtime = 'childMarkdownRemark___frontmatter___cover___mtime',
  childMarkdownRemark___frontmatter___cover___ctime = 'childMarkdownRemark___frontmatter___cover___ctime',
  childMarkdownRemark___frontmatter___cover___birthtime = 'childMarkdownRemark___frontmatter___cover___birthtime',
  childMarkdownRemark___frontmatter___cover___birthtimeMs = 'childMarkdownRemark___frontmatter___cover___birthtimeMs',
  childMarkdownRemark___frontmatter___cover___blksize = 'childMarkdownRemark___frontmatter___cover___blksize',
  childMarkdownRemark___frontmatter___cover___blocks = 'childMarkdownRemark___frontmatter___cover___blocks',
...
export enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___cover___sourceInstanceName = 'frontmatter___cover___sourceInstanceName',
  frontmatter___cover___absolutePath = 'frontmatter___cover___absolutePath',
  frontmatter___cover___relativePath = 'frontmatter___cover___relativePath',
  frontmatter___cover___extension = 'frontmatter___cover___extension',
  frontmatter___cover___size = 'frontmatter___cover___size',
  frontmatter___cover___prettySize = 'frontmatter___cover___prettySize',
  frontmatter___cover___modifiedTime = 'frontmatter___cover___modifiedTime',
  frontmatter___cover___accessTime = 'frontmatter___cover___accessTime',
  frontmatter___cover___changeTime = 'frontmatter___cover___changeTime',
  frontmatter___cover___birthTime = 'frontmatter___cover___birthTime',
  frontmatter___cover___root = 'frontmatter___cover___root',
  frontmatter___cover___dir = 'frontmatter___cover___dir',
  frontmatter___cover___base = 'frontmatter___cover___base',
  frontmatter___cover___ext = 'frontmatter___cover___ext',
  frontmatter___cover___name = 'frontmatter___cover___name',
  frontmatter___cover___relativeDirectory = 'frontmatter___cover___relativeDirectory',
  frontmatter___cover___dev = 'frontmatter___cover___dev',
  frontmatter___cover___mode = 'frontmatter___cover___mode',
  frontmatter___cover___nlink = 'frontmatter___cover___nlink',
  frontmatter___cover___uid = 'frontmatter___cover___uid',
  frontmatter___cover___gid = 'frontmatter___cover___gid',
  frontmatter___cover___rdev = 'frontmatter___cover___rdev',
  frontmatter___cover___ino = 'frontmatter___cover___ino',
  frontmatter___cover___atimeMs = 'frontmatter___cover___atimeMs',
  frontmatter___cover___mtimeMs = 'frontmatter___cover___mtimeMs',
  frontmatter___cover___ctimeMs = 'frontmatter___cover___ctimeMs',
  frontmatter___cover___atime = 'frontmatter___cover___atime',
  frontmatter___cover___mtime = 'frontmatter___cover___mtime',
  frontmatter___cover___ctime = 'frontmatter___cover___ctime',
  frontmatter___cover___birthtime = 'frontmatter___cover___birthtime',
  frontmatter___cover___birthtimeMs = 'frontmatter___cover___birthtimeMs',
  frontmatter___cover___blksize = 'frontmatter___cover___blksize',
  frontmatter___cover___blocks = 'frontmatter___cover___blocks',
  frontmatter___cover___publicURL = 'frontmatter___cover___publicURL',
  frontmatter___cover___childImageSharp___id = 'frontmatter___cover___childImageSharp___id',
  frontmatter___cover___childImageSharp___children = 'frontmatter___cover___childImageSharp___children',
  frontmatter___cover___id = 'frontmatter___cover___id',
  frontmatter___cover___parent___id = 'frontmatter___cover___parent___id',
  frontmatter___cover___parent___children = 'frontmatter___cover___parent___children',
  frontmatter___cover___children = 'frontmatter___cover___children',
  frontmatter___cover___children___id = 'frontmatter___cover___children___id',
  frontmatter___cover___children___children = 'frontmatter___cover___children___children',
  frontmatter___cover___internal___content = 'frontmatter___cover___internal___content',
  frontmatter___cover___internal___contentDigest = 'frontmatter___cover___internal___contentDigest',
  frontmatter___cover___internal___description = 'frontmatter___cover___internal___description',
  frontmatter___cover___internal___fieldOwners = 'frontmatter___cover___internal___fieldOwners',
  frontmatter___cover___internal___ignoreType = 'frontmatter___cover___internal___ignoreType',
  frontmatter___cover___internal___mediaType = 'frontmatter___cover___internal___mediaType',
  frontmatter___cover___internal___owner = 'frontmatter___cover___internal___owner',
  frontmatter___cover___internal___type = 'frontmatter___cover___internal___type',
  frontmatter___cover___childMarkdownRemark___id = 'frontmatter___cover___childMarkdownRemark___id',
  frontmatter___cover___childMarkdownRemark___excerpt = 'frontmatter___cover___childMarkdownRemark___excerpt',
  frontmatter___cover___childMarkdownRemark___rawMarkdownBody = 'frontmatter___cover___childMarkdownRemark___rawMarkdownBody',
  frontmatter___cover___childMarkdownRemark___fileAbsolutePath = 'frontmatter___cover___childMarkdownRemark___fileAbsolutePath',
  frontmatter___cover___childMarkdownRemark___html = 'frontmatter___cover___childMarkdownRemark___html',
  frontmatter___cover___childMarkdownRemark___htmlAst = 'frontmatter___cover___childMarkdownRemark___htmlAst',
  frontmatter___cover___childMarkdownRemark___excerptAst = 'frontmatter___cover___childMarkdownRemark___excerptAst',
  frontmatter___cover___childMarkdownRemark___headings = 'frontmatter___cover___childMarkdownRemark___headings',
...
export enum SiteFieldsEnum {
  ...
  siteMetadata___baseUrl = 'siteMetadata___baseUrl',
  siteMetadata___socials = 'siteMetadata___socials',
...
export enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___toasterText = 'pluginCreator___pluginOptions___toasterText',
...
export enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___toasterText = 'pluginOptions___plugins___pluginOptions___toasterText',
  ...
  pluginOptions___toasterText = 'pluginOptions___toasterText',
...
export type SitePluginPluginOptions = {
  ...
  name?: Maybe<Scalars['String']>,
  path?: Maybe<Scalars['String']>,
  toasterText?: Maybe<Scalars['String']>,
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  name?: Maybe<StringQueryOperatorInput>,
  path?: Maybe<StringQueryOperatorInput>,
  toasterText?: Maybe<StringQueryOperatorInput>,
...
export type SiteSiteMetadataSocialsFilterListInput = {
  elemMatch?: Maybe<SiteSiteMetadataSocialsFilterInput>,
};
